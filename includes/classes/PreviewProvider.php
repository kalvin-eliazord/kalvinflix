...
class PreviewProvider {
    ...
    public function createPreviewVideo($entity) {
        ...
        $video = new Video($this->con, $videoId, null);
    ...
    public function createEntityPreviewSquareAdmin($entity) {
        $id = $entity->getId();
        $thumbnail = $entity->getThumbnail();
        $name = $entity->getName();

        return "<a href='entityAdmin.php?id=$id'>
                    <div class='previewContainer small'>
                        <img src='$thumbnail' title='$name'>
                    </div>
                </a>
                <a href='entityManagement.php?id=$id'>
